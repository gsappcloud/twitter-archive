<?php
	...
	$config = array(
		// REQUIRED VALUES ------------------------------------
		'twitter_screenname' => 'gsapponline', // Your Twitter screen name
		...
		'db'                 => array(
			...
			'username'       => 'twitterarchive', // The username to log in to your database
			'password'       => 'gs@tARCH12', // The password to log in to your database
			'database'       => 'twitter_archive', // The database name
		...
		'maintenance_http_password' => 'tw33SAPP@12', 
